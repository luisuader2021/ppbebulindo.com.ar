...
if(isset($_GET["art"]) and strlen($_GET["art"]) > 1 ) {$busqueda.=" AND articulo LIKE '%".$_GET["art"]."%'order by cat desc, ordEdad";$sinbus=0;}
...
if($sinbus===0){
  ...
  echo "<h4>  Mostrando los artículos que contienen: ".$_GET["art"]."</h4></div></div></div></div>";
