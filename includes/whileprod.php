             ...
             <div class='<? echo $producto[1]; ?> prod'>
                      <div class='d1'>
                        ...
                        <div class='info li'><? echo $producto[23]; ?><br>                        
                          <div class='talle'><span>Talle: </span><? echo $producto[14]; ?></div>
                          <b><? echo $bcodbar; ?></b>
                          <div class='cod'>Art. <? echo $producto[22]; ?></div>
                          <a href='https://api.whatsapp.com/send?phone=5493436209824&text=http://bebulindo.com.ar/p/<? echo codArt($producto[21])." ".$palabra;?>:%20Art<? echo $producto[22]; ?>II<? echo $bcodbar; ?>%20*T<? echo $producto[14]; ?>*%20*<? echo $descr; ?>* '  class='wsp'><? echo $palabra;?></a>
